        ...
        stages: [
          {
            ...
            inputs: { files: ["context.yaml"], allowRead: true, allowWrite: false },
            outputs: { files: ["requirements.yaml"], schemas: [], traceRequired: false },
            gates: { required: ["context_exists"], optional: [], autoUpdate: false },
          },
          {
            id: "design",
            name: "Design",
            ...
            inputs: { files: ["requirements.yaml"], allowRead: true, allowWrite: false },
            outputs: { files: ["design.md"], schemas: [], traceRequired: false },
            gates: { required: ["requirements_ready"], optional: [], autoUpdate: false },
          },
          {
            id: "implement",
            name: "Implementation",
            ...
            inputs: { files: ["design.md"], allowRead: true, allowWrite: false },
            outputs: { files: ["implementation.md"], schemas: [], traceRequired: false },
            gates: { required: ["design_ready"], optional: [], autoUpdate: false },
          },
        ],
        failure_handling: {
          retry: {
