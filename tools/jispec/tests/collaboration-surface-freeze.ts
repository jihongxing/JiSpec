...
async function main(): Promise<void> {
  ...
  const planPath = path.join(repoRoot, "docs", "development", "collaboration-surface-freeze.md");
  const freezeDocPath = path.join(repoRoot, "docs", "development", "collaboration-surface-freeze.md");
  ...
  record("docs expose the frozen boundary and promotion rule", () => {
    ...
    assert.ok(stableContract.includes("docs/development/collaboration-surface-freeze.md"));
