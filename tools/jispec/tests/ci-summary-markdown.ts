...
async function main(): Promise<void> {
  ...
  try {
    ...
    assert.ok(verifySummary.includes("Evidence: `.jispec-ci/verify-report.json` or `.spec/handoffs/verify-summary.md`, facts contract `1.0`, 2 matched policy rule(s), 1 matched waiver(s)"));
