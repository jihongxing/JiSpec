...
export const TEST_SUITES: TestSuite[] = [
  ...
  retakeover({ name: 'Retakeover Benchmark Pool', file: 'retakeover-benchmark-pool.ts', expectedTests: 3, task: 'North-Star-Score-Phase-1' }),
  retakeover({ name: 'Retakeover Realism Ladder', file: 'retakeover-realism-ladder.ts', expectedTests: 4, task: 'North-Star-Score-Phase-6' }),
  ...
  gates({ name: 'CI Verify Wrapper', file: 'ci-verify-wrapper.ts', expectedTests: 4 }),
  ...
  gates({ name: 'Installable CLI Surface', file: 'installable-cli-surface.ts', expectedTests: 7, task: 'v0.2.0' }),
  ...
  changeImplement({ name: 'Mainline Flow Recovery', file: 'mainline-flow-recovery.ts', expectedTests: 7, task: 'North-Star-Score-Phase-4' }),
  changeImplement({ name: 'Mainline Recovery Drill', file: 'mainline-recovery-drill.ts', expectedTests: 6, task: 'North-Star-Score-Phase-9' }),
  ...
  runtime({ name: 'Console Decision Deck', file: 'console-decision-deck.ts', expectedTests: 5, task: 'North-Star-Score-Phase-3' }),
  runtime({ name: 'Console Runbook Mode', file: 'console-runbook-mode.ts', expectedTests: 5, task: 'North-Star-Score-Phase-8' }),
  runtime({ name: 'Global Operations Packet', file: 'global-operations-packet.ts', expectedTests: 6, task: 'North-Star-Score-Phase-10' }),
  runtime({ name: 'Org Responsibility Graph', file: 'org-responsibility-graph.ts', expectedTests: 6, task: 'North-Star-Score-Phase-11' }),
  runtime({ name: 'Async Review Inbox', file: 'async-review-inbox.ts', expectedTests: 6, task: 'North-Star-Score-Phase-12' }),
  runtime({ name: 'Ops Aging Ledger', file: 'ops-aging-ledger.ts', expectedTests: 6, task: 'North-Star-Score-Phase-13' }),
  runtime({ name: 'Release Train Packet', file: 'release-train-packet.ts', expectedTests: 6, task: 'North-Star-Score-Phase-14' }),
  runtime({ name: 'Org Operations Console', file: 'org-operations-console.ts', expectedTests: 6, task: 'North-Star-Score-Phase-15' }),
  ...
  runtime({ name: 'Multi-Repo Promotion Readiness', file: 'multi-repo-promotion-readiness.ts', expectedTests: 5, task: 'North-Star-Score-Phase-2' }),
