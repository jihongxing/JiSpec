...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log("✓ Test 2: policy migration scaffolds a starter policy pinned to the current facts contract");
    passed++;
    ...
    console.log("✓ Test 3: migrated policy round-trips through the YAML loader");
    passed++;
  } catch (error) {
