...
Use this page for decision criteria.
Use [../getting-started/first-takeover-walkthrough.md](../getting-started/first-takeover-walkthrough.md) when you want the commands in execution order.
...
If you are trying JiSpec for the first time, run the walkthrough first and come back here when you need to decide how to treat the draft.
...
This guide deliberately does not repeat the full first-run script. For the procedural path, use [../getting-started/first-takeover-walkthrough.md](../getting-started/first-takeover-walkthrough.md).
