...
Use [./policy-waiver-spec-debt-cookbook.md](./policy-waiver-spec-debt-cookbook.md) when you want the broader policy/governance command map rather than the approval contract itself.
