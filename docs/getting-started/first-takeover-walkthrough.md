...
Use this page for command order.
Use [../user-guide/takeover-guide.md](../user-guide/takeover-guide.md) for adoption judgment, especially when deciding accept, edit, defer, or reject.
...
If you need the decision criteria behind those choices, switch to [../user-guide/takeover-guide.md](../user-guide/takeover-guide.md) before adopting.
...
CI should call this same wrapper. See [../ci-templates.md](../ci-templates.md).
...
For the day-to-day meaning of adopt decisions after this walkthrough, continue with [../user-guide/takeover-guide.md](../user-guide/takeover-guide.md).
